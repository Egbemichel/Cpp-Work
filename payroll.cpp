...
void saveRecords(Employee emp[], int num)
{
    if (num == 0)
    {
        ...
        for (int i = 0; i < num; i++)
            {
                file << emp[i].name << "\t" << emp[i].jobCode << "\t" << emp[i].designation << "\t" << emp[i].exp << "\t" << emp[i].age << "\t" << emp[i].salary << "\t" << emp[i].anyLoan << "\t" << emp[i].tax << "\t" << emp[i].mealAllowance << "\t" << emp[i].transportAllowance << "\t" << emp[i].medicalAllowance << "\t" << emp[i].loanBalance << "\t" << emp[i].loanDebit << "\t"
